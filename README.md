...
- At the top-left of the screen select New Script and paste the contents of the following script into it. What this script will do is create around 10,000 employees for this domain.
